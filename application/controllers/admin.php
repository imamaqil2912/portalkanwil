...
class Admin extends CI_Controller
{
  ...
  {
    $this->load->view ("admin/elemen/header");
	$this->load->view ("admin/elemen/nav");
	redirect('admin/set_banner');
	$this->load->view ("admin/elemen/footer");
  }
  ...
  function set_banner(){
				...
				$data["det"] = $this->admin_model->tampil_banner();
				$this->template->load('template','admin/banner_input', $data);
	}
		...
		function hapus_banner()
	{
		...
		{
				$file = 'assets/banner/'.$gb;
				unlink($file);
				$data["upd"] = $this->admin_model->hapus_banner($kode,"kode_banner","tbl_banner");
				echo "<meta http-equiv='refresh' content='0; url=".base_url()."index.php/admin/set_banner'>";
			}
		}
