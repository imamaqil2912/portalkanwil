...
<form method="post" action="<?php echo base_url(); ?>index.php/admin/update_banner" enctype="multipart/form-data">
...
<tr><td width="120" valign="top">Gambar</td><td width="10" valign="top">:</td><td><img src="<?php echo base_url(); ?>assets/banner/<?php echo $d['gambar']; ?>" width="600" /></td></tr>
