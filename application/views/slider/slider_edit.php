...
<legend align="left"><strong>Form Edit Slider :</strong></legend>
<form method="post" action="<?php echo base_url(); ?>slider/update_slider" enctype="multipart/form-data">
...
<tr><td width="120" valign="top">Gambar</td><td width="10" valign="top">:</td><td><img src="<?php echo base_url(); ?>assets/slider/<?php echo $d['gambar']; ?>" width="600" /></td></tr>
