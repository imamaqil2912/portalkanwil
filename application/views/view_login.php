...
<br />
<br />
<form method="post" action="<?php echo base_url();?>index.php/login/login_form">
<div id="bg-login">
<div id="judul"><img src="<?php echo base_url(); ?>assets/images/logo-login.png" /></div>
...
<div style="margin:0px auto; width:100%; clear:both;"></div>
<div id="bg-login-kiri"></div><div id="bg-login-kanan"><input type="submit" class="tombol" value="Masuk" /> 
		<input type="reset" class="tombol" value="Hapus" /></div>
<div id="judul"><br />LOGIN Khusus ADMIN - <?php echo date('Y'); ?></div>
</div>
</form>
</body>
</html>
